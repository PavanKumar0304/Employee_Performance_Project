...
Handling missing values and preparing dataset for modeling

2. numpy

Numerical operations

Supporting ML computations

3. seaborn & matplotlib

Used to create powerful HR analytics visualizations:
...
Logistic Regression & Decision Tree modeling
...
Created a target variable → High vs Low Performance

Applied preprocessing pipelines (imputing, scaling, encoding)
...
Built HR-focused visualizations

Generated insights HR teams can use
